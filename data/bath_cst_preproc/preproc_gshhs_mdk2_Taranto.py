...
def extract_coastline(x_mod,y_mod,input_file,output_file):
	...
	for t in IX:
		...
		for r in np.arange(0,iCoastalSection.size/2,1):
			try:
				CoastFile.write("%-8.5f %-6.5f \n" % (iCoastalSection[int(r),0], iCoastalSection[int(r),1]))
			except:
...
gshhs_filename =  "/work/opa/witoil-dev/mdk2-sanifs/EXE/data/bath_cst_preproc/gshhs_f.b"

# define where outputs will be placed (MEDSLIK-adapted nc files)
output_dir= "/work/opa/witoil-dev/mdk2-sanifs/EXE/data/"
