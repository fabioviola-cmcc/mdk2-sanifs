...
def open_mercator(sFileName):
	...
	iT=fM.variables["votemper"][:] # water temperature in deg C
	return x,y,iT
...
gebco_filename = '/work/opa/witoil-dev/mdk2-sanifs/EXE/data/bath_cst_preproc/GEBCO_2014_1D.nc'

# define where outputs will be placed (MEDSLIK-adapted nc files)
output_dir= "/work/opa/witoil-dev/mdk2-sanifs/EXE/data/bath_cst_preproc/"
...
oce_dir = "/work/opa/witoil-dev/mdk2-sanifs/DATA/fcst_data/H3k/"
...
# write .bath file
BathFile=open(output_dir + "medf_.bath.mercator.FABIO", "w")
